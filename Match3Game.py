...
def draw_grid():
    ...
    for row in range(GRID_SIZE):
        for col in range(GRID_SIZE):
            # 1. Calculate the coordinates of the top-left corner of the current cell, used to draw the background line.# 1. Calculate the coordinates of the top-left corner of the current cell, used to draw the background line.
